...
path_circuit_otomai = Path(path_my_bot,"circuit","otomai.txt")
...
################  Otomai  ##################
pos_banque_otomai = "-47,21"
x_entre_banque_otomai,y_entre_banque_otomai =  896 , 527 # click entrer dans la banque
x_sortie_banque_otomai, y_sortie_banque_otomai =  751 , 713 #clic quitter la banque
#coffre bank
x_hibou_banque_otomai, y_hibou_banque_otomai =983 , 533 # clique parler à l hibou
# Cofre de guilde #
x_coffre_guilde_otomai_ouvrir, y_coffre_guilde_otomai_ouvrir = 735 , 422
